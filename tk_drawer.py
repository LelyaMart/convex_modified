...
class TkDrawer:
    ...
    def clean(self, triangle):
        ...
        self.canvas.create_line(x(triangle[0].first), y(triangle[0].first),
                                x(triangle[0].second), y(triangle[0].second),
                                fill='red', width=2)
        self.canvas.create_line(x(triangle[1].first), y(triangle[1].first),
                                x(triangle[1].second), y(triangle[1].second),
                                fill='red', width=2)
        self.canvas.create_line(x(triangle[2].first), y(triangle[2].first),
                                x(triangle[2].second), y(triangle[2].second),
                                fill='red', width=2)
        self.root.update()
